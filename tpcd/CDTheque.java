...
public class CDTheque implements Iterable<CDAudio> {
	...
	public CDTheque(List<CDAudio> catalogue, Map<Long, CDAudio> cdByISBN, Map<String, CDAudio> cdByArtistTtle,
			Map<String, CDAudio> cdByStyleTitle) {
		super();
		this.catalogue = catalogue;
		this.cdByISBN = cdByISBN;
		this.cdByArtistTtle = cdByArtistTitle;
