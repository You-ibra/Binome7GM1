...
public class CDTheque implements Iterable<CDAudio> {
    ...
    private Map<String,CDAudio> cdByArtistTitle;
	...
	public CDTheque(List<CDAudio> catalogue, Map<Long, CDAudio> cdByISBN, Map<String, CDAudio> cdByArtistTitle,
			Map<String, CDAudio> cdByStyleTitle) {
		super();
		this.catalogue = catalogue;
		this.cdByISBN = cdByISBN;
		this.cdByArtistTitle = cdByArtistTitle;
	...
	public CDAudio getCDparArtisteTitre(String artiste, String titre) {
		return cdByArtistTitle.get(clef(artiste,titre));
		// TODO
	}
	 ...
	 */
  	public void charger(String nomFichier) {
		...
		this.ajouterCD(1, "J.Geils Band","J.Geils Band", "live in Detroit", "Rythm&Blues", 14);
		this.ajouterCD(2, "Deep Purple","J.Geils Band", "Made in Europe", "Hard Rock", 12);
		this.ajouterCD(3, "Rolling Stones","J.Geils Band", "Love you Live", "Rythm&Blues", 7);
	}
